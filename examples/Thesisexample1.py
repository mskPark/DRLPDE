...
def inlet_con(X):
    ...
    u[:,0] = v0*(L_height - X[:,1])*(L_height + X[:,1])/(L_height**2)*torch.tanh(4*X[:,2])
...
disk1 = {   'type':'disk',
            ...
            'radius': L_height/3.0,
            'endpoints': [],
            'boundary_condition':ball_con }

disk2 = {   'type':'disk',
            'centre': [2.5*L_height,0.5*L_height],
            'radius': L_height/3.0,
            'endpoints': [],
            'boundary_condition':ball_con}

disk3 = {   'type':'disk',
            'centre': [3.25*L_height,-0.5*L_height],
            'radius': L_height/3.0,
            'endpoints': [],
            'boundary_condition':ball_con }
...
list_of_walls = [circle1, circle2, circle3, wall_left, wall_top,  wall_bot, wall_right]
list_of_periodic_ends =[]
solid_walls = [disk1, disk2, disk3]
inlet_outlet = []
mesh = []
